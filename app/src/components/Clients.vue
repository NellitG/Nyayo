...
<section class="bg-white">
    <div class="container px-6 py-10 mx-auto">
        <div class="mt-6 md:flex md:items-center md:justify-between lg:justify-center">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-4xl">
                    What our clients are saying
                </h1>

                <div class="flex mx-auto mt-6 justify-center">
        ...
        <section class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3 ">
            <div class="p-8 border rounded-lg hover:bg-yellow-600">
            ...
            <div class="p-8 border rounded-lg hover:bg-yellow-600">
                ...
                <div class="flex items-center mt-8 -mx-2">
                    ...
                    <div class="mx-2">
                        ...
                        <span class="text-sm text-grey-500">CEO, Jeny Consultency</span>
                    </div>
                </div>
            </div>
