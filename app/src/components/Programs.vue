  ...
  <div class="bg-white py-10">
    <div class="container mx-auto px-4">
      ...
      <div class="mt-24 text-center">
        ...
        <p class="text-lg text-indigo-400 mt-2">Discover the initiatives we’ve taken to create a more inclusive world.</p>
      </div>

      <!-- Inclusive Education Section -->
      <div class="flex flex-col lg:flex-row items-center lg:items-start mt-12">
        <div class="lg:w-1/2">
          <h3 class="text-3xl font-semibold text-gray-950">Inclusive Education</h3>
