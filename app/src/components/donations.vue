<template>
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div class="relative">
      ...
      <div class="relative">
        <div class="bg-yellow-300 rounded-full w-72 h-72 mx-auto flex items-center justify-center overflow-hidden">
          <img src="volunteer.jpg" alt="Volunteer" class="w-64 h-64 object-cover">
        </div>
        <!-- Floating Badge -->
        <div class="absolute top-4 left-10 bg-green-600 text-white px-4 py-2 rounded-lg shadow-md">
    ...
    <!-- Right Section -->
    <div class="space-y-6">
      <p class="text-green-600 font-semibold uppercase">Welcome to Stitch Non-Profit Charity</p>
