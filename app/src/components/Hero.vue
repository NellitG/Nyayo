    ...
    <div class="container mx-auto relative z-10 mt-24 py-10">
      <div class="grid grid-cols-12 text-center lg:text-start">
        ...
        >
          ...
          <!-- New Text Block -->
          <p
            class="antialiased font-sans text-lg leading-relaxed text-inherit mb-10 text-white lg:text-white"
          >
          ...
          <div class="flex justify-center gap-4 mb-8 lg:justify-start">
            ...
            <router-link to="/aboutus">
              <button
                class="align-middle select-none font-semibold text-center lg:text-white uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg border-blue-900 border-2 text-black hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-[0.85]"
                type="button"
              >
                read more
              </button>
