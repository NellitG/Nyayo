<template>
  ...
  <div class="container mx-auto">
    ...
    <div class="text-center mb-10">
      <h2 class="text-4xl font-bold text-gray-950">Our Journey: Key Milestones</h2>
    ...
    <div class="relative border-1 border-gray-300">
      ...
      <div class="mb-10 ml-24">
        ...
        <div class="ml-4">
          <h3 class="text-lg font-bold text-gray-950">2024: NGO Launch</h3>
      ...
      <div class="mb-10 ml-24">
        <div class="absolute w-4 h-4 bg-yellow-400 rounded-full -left-0 border-2 border-white"></div>
        <div class="ml-4">
          <h3 class="text-lg font-bold text-gray-950">2025: First Partnership</h3>
      ...
      <div class="mb-10 ml-24">
        <div class="absolute w-4 h-4 bg-yellow-400 rounded-full -left-0 border-2 border-white"></div>
        <div class="ml-4">
          <h3 class="text-lg font-bold text-gray-950">2026: Expansion</h3>
      ...
      <div class="mb-10 ml-24">
        <div class="absolute w-4 h-4 bg-yellow-400 rounded-full -left-0 border-2 border-white"></div>
        <div class="ml-4">
          <h3 class="text-lg font-bold text-gray-950">2027: Advocacy for Policy Change</h3>
