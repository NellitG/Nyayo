<template>
  ...
  <div class="text-center ">
      <h1 class="text-4xl font-extrabold tracking-tight text-indigo-950 sm:text-5xl md:text-6xl">
          ...
          <div class="">
              <span class="relative mt-3 whitespace-nowrap text-indigo-950"><svg aria-hidden="true" viewBox="0 0 418 42"
                      class="absolute top-3/4 left-0 right-0 m-auto h-[0.58em] w-fit fill-yellow-400/50"
    ...
    <div class="rounded-md shadow">
        <a
            class="flex w-full items-center justify-center rounded-md border border-yellow-400 bg-white px-8 py-3 text-base font-medium text-gray-950 hover:bg-yellow-400 md:py-4 md:px-10 md:text-lg"
