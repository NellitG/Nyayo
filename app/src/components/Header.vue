<template>
 <nav class="bg-white text-black py-0">
  <div class="container mx-auto px-4 flex  flex-row justify-center items-center max-w-7xl">
    ...
    <div class="lg:flex lg:justify-end lg:items-end pr-8 space-x-3 hidden pt-4 justify-end">
      <a href="#" class="px-6 py-2 bg-white hover:bg-yellow-600 hover:text-white rounded-full pr-8 border-2 border-yellow-600 text-black text-center">Hire Me</a>
