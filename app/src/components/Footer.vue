  ...
  <footer class="bg-white">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex -mx-2">
                <a href="#" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-600" aria-label="Reddit">
                ...
                <a href="#" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-600" aria-label="Facebook">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-600" aria-label="Github">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
